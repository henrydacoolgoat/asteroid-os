...
const checks = [
  ['visible brand is Asteroid OS One', page.includes('<meta name="application-name" content="Asteroid OS One"') && page.includes('<title>Asteroid OS One v0.99.23.10')],
  ['release metadata uses one consistent build id', page.includes('<meta name="asteroid-build" content="asteroid-os-one-v0.99.23.10-2026-08-17"') && page.includes("const ASTEROID_RELEASE_BUILD='asteroid-os-one-v0.99.23.10-2026-08-17';")],
