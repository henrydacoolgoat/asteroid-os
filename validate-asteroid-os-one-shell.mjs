...
const checks = [
  ['visible brand is Asteroid OS One', page.includes('<meta name="application-name" content="Asteroid OS One"') && page.includes('<title>Asteroid OS One v0.99.23.14')],
  ['release metadata uses one consistent build id', page.includes('<meta name="asteroid-build" content="asteroid-os-one-v0.99.23.14-2026-08-17"') && page.includes("const ASTEROID_RELEASE_BUILD='asteroid-os-one-v0.99.23.14-2026-08-17';")],
  ...
  ['shelf exposes grouped controls, notifications, and date', page.includes('id="controlButton" title="Quick controls"') && page.includes('id="notificationButton" title="Notifications"') && page.includes('id="menuDate"')],
  ['shelf components use repository and licensed icon assets', ['search.svg','wifi.svg','volume-2.svg','bell.svg'].every(name=>page.includes(`assets/ui-icons/${name}`))],
