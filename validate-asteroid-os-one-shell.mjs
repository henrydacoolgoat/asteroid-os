...
const checks = [
  ['visible brand is Asteroid OS One', page.includes('<meta name="application-name" content="Asteroid OS One"') && page.includes('<title>Asteroid OS One v0.99.23.19')],
  ['release metadata uses one consistent build id', page.includes('<meta name="asteroid-build" content="asteroid-os-one-v0.99.23.19-2026-08-20"') && page.includes("const ASTEROID_RELEASE_BUILD='asteroid-os-one-v0.99.23.19-2026-08-20';")],
  ...
  ['desktop shelf uses twice-size pinned icons without clipping', page.includes(':root{--menu-h:0px!important;--dock-h:78px;--system-bar-h:78px}') && page.includes('width:188px!important;height:32px!important') && page.includes('width:60px!important;height:60px!important;filter:none!important') && page.includes('width:66px!important;height:72px!important')],
