...
const checks = [
  ['visible brand is Asteroid OS One', page.includes('<meta name="application-name" content="Asteroid OS One"') && page.includes('<title>Asteroid OS One v0.99.23.9')],
  ['release metadata uses one consistent build id', page.includes('<meta name="asteroid-build" content="asteroid-os-one-v0.99.23.9-2026-08-17"') && page.includes("const ASTEROID_RELEASE_BUILD='asteroid-os-one-v0.99.23.9-2026-08-17';")],
  ['top-level document replacement guard loads before application markup', page.indexOf('__asteroidTopDocumentGuardInstalled') > page.indexOf('<script id="asteroid-top-level-guard">') && page.indexOf('__asteroidTopDocumentGuardInstalled') < page.indexOf('id="asteroidAuthGate"') && page.indexOf('__asteroidTopDocumentGuardInstalled') < page.indexOf('id="messageXEmbeddedSource"') && page.includes("const asteroidShellDocument=document.querySelector('meta[name=\"asteroid-build\"]')?.content?.startsWith('asteroid-os-one-')===true;") && page.includes("if(asteroidShellDocument&&!window.__asteroidTopDocumentGuardInstalled)") && page.includes("documentPrototype.open=function(...args){if(this===shellDocument){blocked('open',args[0]);return shellDocument}") && page.includes("documentPrototype.write=function(...args){if(this===shellDocument){blocked('write',args[0]);return}")],
