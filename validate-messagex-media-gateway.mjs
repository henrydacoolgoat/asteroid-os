...
const build = 'messagex-v0994-post-ticket-resilient-permanent-gateway-asteroid-bundled-2026-08-06';
const asteroidBuild = 'asteroid-os-v0.99.23.4-post-ticket-permanent-messagex-gateway-2026-08-06';
...
const checks = [
  ...
  ['media requests use three bounded attempts', canonical.includes('const MESSAGE_X_MEDIA_RETRY_DELAYS_MS = [0, 750, 2000];') && retryFunction.includes('attempt < MESSAGE_X_MEDIA_RETRY_DELAYS_MS.length')],
