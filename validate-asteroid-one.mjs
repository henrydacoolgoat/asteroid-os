...
const checks = [
  ['release and feature build markers are present', client.includes('asteroid-os-one-v0.99.23.14-2026-08-17') && client.includes("const ASTEROID_ONE_BUILD='asteroid-one-files-account-state-2026-08-12';")],
